/****************************************************************************
** Meta object code from reading C++ file 'queue_manager.h'
**
...
#error "The header file 'queue_manager.h' doesn't include <QObject>."
...
template <> constexpr inline auto QueueManager::qt_create_metaobjectdata<qt_meta_tag_ZN12QueueManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'ticketCalled'
        QtMocHelpers::SignalData<void(const Ticket &)>(3, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
    };
...
void QueueManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->ticketCalled((*reinterpret_cast< std::add_pointer_t<Ticket>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (QueueManager::*)()>(_a, &QueueManager::queueUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (QueueManager::*)(const Ticket & )>(_a, &QueueManager::ticketCalled, 1))
            return;
    }
}
...
// SIGNAL 0
void QueueManager::queueUpdated()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void QueueManager::ticketCalled(const Ticket & _t1)
{

...
#include "receptionist_window.h" // <-- Inclui o novo cabeçalho
#include <QVBoxLayout>
#include <QListWidget>
#include <QPushButton>
#include "queue_manager.h"

// O construtor agora é definido fora da classe, com "ReceptionistWindow::"
ReceptionistWindow::ReceptionistWindow(QWidget* parent) : QWidget(parent) {
    ...
    connect(callButton, &QPushButton::clicked, [=]() {
        ...
        // A atualização agora pode ser feita diretamente pelo signal/slot, mas manter aqui também funciona
        // updateQueueList(); 
    });
...
// A função updateQueueList também é definida fora da classe
void ReceptionistWindow::updateQueueList() {
    queueList->clear();
